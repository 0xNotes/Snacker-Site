...
export default function NFTSelect({
    ...
    return (
        <div className="NFTContainerMobile" style={{ backgroundImage: `url(${backgroundTexture})`, objectFit: "fill" }}>


            <div className="FeatureContainerMobile">
            <div className="FeatureTextContainerMobile">{names[position] + " #" + id[position]}</div>
            <img className="FeaturedNFTMobile" src={pics[position]}/>
            <button className="ApproveButtonMobile">APPROVE</button>
            </div>


            <div className="NFTSelectorMobile" style={{ backgroundImage: `url(${bottomTexture})`, objectFit: "fill" }}>
                <img src={arrowLeft} onClick={() => setPosition(numberFix(position-1))}></img>
                <img className="NFTPreviewMobile" src={pics[numberFix(position-2)]}/>
                <img className="NFTPreviewMobile" src={pics[numberFix(position-1)]}/>
                <img className="NFTCenterMobile" src={pics[numberFix(position)]}/>
